export const postData_En = {
  name: "Egemen Sucuoglu",
  birthDate: "12.04.1998",
  location: "Istanbul",
  education: "ITU - Electrical Engineering",
  position: "Frondend Developer,UI",
  aboutTitle: "About",
  about:
    "My career goal is to become a member of a team within the areas of power electronics, electrical machines, renewable energy or generation of electrical energy and improve what I learned in my undergraduate education Possess in-depth knowledge of complex electrical concepts, mathematics,and coding, and adept at applying theories and ideas in real-world situations.Strong analytical thinking, excellent communication and interpersonal skills – able to work effectively alone or with others. I also improve myself in software systems , which become increasingly important in the future.",
  darkMod: "DARK MODE",
  lightMod: "LIGHT MODE",
  language: "TÜRKÇE",
  languageEk: "'YE GEÇ",
  ...
  headerHireMe: "Contact!",
  aboutTitle1: "Creative thinker ",
  aboutTitle2: "Minimalism lover",
  aboutDesc:
    "Hi, I’m Egemen. I’m a full-stack developer. If you are looking for a Developer who to craft solid and scalable frontend products with great user experiences. Let’s shake hands with me.",
  aboutHireMe: "Contact!",
  skillsDesc1:
  ...
  projectsCalculator: "Calculator",
  projectsCalculatorDesc:
  ...
  projectsTwitter: "Twitter On 90’s",
  projectsTwitterDesc:
...
export const postData_Tr = {
  name: "Egemen Sucuoğlu",
  birthDate: "12.04.1998",
  location: "İstanbul",
  education: "İTÜ - Elektrik Mühendisliği",
  position: "Frondend Developer,UI",
  aboutTitle: "Hakkında",
  about:
    "Kariyer hedefim, güç elektroniği, elektrik makineleri, yenilenebilir enerji sistemleri veya elektrik enerjisi üretimi alanlarında iyi bir ekip üyesi olmak ve lisans eğitimimde öğrendiklerimi geliştirmektir. Karmaşık elektrik kavramları, matematik ve kodlama konularında derinlemesine bilgi sahibiyim ve teorileri ve fikirleri gerçek dünya durumlarına uygulama konusunda yetenekliyim. Güçlü analitik düşünme becerilerine sahibim, mükemmel iletişim ve kişilerarası becerilere sahibim bireysel veya takım arkadaşlarımla etkili bir şekilde çalışabilirim. Aynı zamanda gelecekte giderek daha önemli hale gelen yazılım sistemlerinde de kendimi geliştiriyorum.",
  darkMod: "KARANLIK MOD",
  lightMod: "AYDINLIK MOD",
  language: "ENGLISH",
  languageEk: "",
  headerSkills: "Yetenekler",
  headerProjects: "Projeler",
  headerHireMe: "İletişim",
  aboutTitle1: "Yaratıcı",
  aboutTitle2: "Minimalist",
  aboutDesc:
    "Merhaba, ben Egemen. Tam donanımlı bir geliştiriciyim. Harika kullanıcı deneyimleri ile sağlam ve ölçeklenebilir ön uç ürünleri oluşturacak bir Geliştirici arıyorsanız. Hadi benimle iletisime gecin.",
  aboutHireMe: "İletişim",
  ...
  projectVisit: "Hesapla",
  projectsCalculator: "Hesap Makinesi",
  projectsCalculatorDesc:
    "React'in useReducer kancası kullanılarak oluşturulmuş bir hesap makinesi uygulaması olan Reducer Challenge projemle tanışın. Aritmetik işlemleri gerçekleştirin, değerleri bellekte saklayın ve toplam sonucu kolaylıkla takip edin. Uygulama, durumu yönetmek ve hesaplamalar yapmak için bir indirgeyici ve eylemler kullanır. Sayılar, hafıza işlemleri ve temel aritmetik işlevler için düğmeler içeren kullanıcı dostu bir arayüze sahiptir. Toplam ekran mevcut sonucu takip eder ve işlem ve hafıza bölümleri ek bilgiler sağlar. ",

  projectsTwitter: "90’lar twitterın’da özgürce dolaş",
  projectsTwitterDesc:
    "Tasarlanan twitter uygulamamızda gezinirken kendinizi 90lı yıllarda hissedeceksiniz.Tasarımı bize ait olan bu uygulamada dilediğiniz gibi tweet atabilir ayrıca diğer bireylerin attığı tweetleri görebilirsiniz. Ayrıca kullanıcalar profil fotoğraflarını, takipçi sayısı ve tweet sayılarını rahatça görebilmektedir.",

  footerTitle1: "Bir sonraki projenizde ",
  footerTitle2: "birlikte çalışalım.",
  footerBlog: "Kisisel Blog",
  profileTitle: "Profil",
  profileBirth: "Doğum Tarihi",
